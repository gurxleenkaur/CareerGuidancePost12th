...
def tab7_content():
    ...
    if submit:
        ...
        model_college = joblib.load("saved_models/model_college.pkl")
        model_career = joblib.load("saved_models/model_career.pkl")
        model_backup = joblib.load("saved_models/model_backup.pkl")
        model_counsel = joblib.load("saved_models/model_counsel.pkl")
        model_jobrole = joblib.load("saved_models/model_jobrole.pkl")
